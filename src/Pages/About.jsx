...
import teamImage1 from "../assets/img/zakarya.jpg";
    ...
    <div className="animate-slide-in-down">
      <div className="relative flex flex-wrap">
        ...
        <div className="absolute inset-0 flex flex-col md:p-48 p-20 mt-12  ">
          <p className="text-3xl md:text-6xl font-bold text-black">About </p>
      ...
      <div className="animate-slide-in-down">
       ...
       {
          data.map((item) => (
            <div key={item.id} className=" border mx-4 w-[400px] rounded-md hover:bg-pink-600 hover:text-white shadow-md transition-transform duration-500 ease-in-out hover:-translate-y-4 ">
          <h1 className="text-center p-3 text-2xl font-medium">{item.title}</h1>
          
            <img className=" " src={item.img} alt="" />
            <p className="text-center text-2xl font-medium">{item.prop}</p>
